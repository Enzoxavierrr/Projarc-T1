...
public class ListarPedidosClienteEntreguesUC {
    ...
    public List<PedidoListagemResponse> run(String cpf, LocalDate inicio, LocalDate fim) {
        return pedidoService.listarEntreguesDoClienteEntreDatas(cpf, inicio, fim)
            .stream()
